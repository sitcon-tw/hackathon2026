...
const schedule = [
  ...
  },
  {
    ...
    items: [
      ...
      { start: "10:00", end: "14:10", title: "第一輪評選", detail: "依影片、程式碼與文件選出總排名決賽 10 組。", tag: "評選" },
      { start: "14:10", end: "14:30", title: "成績確認與決賽名單公布", detail: "公布總排名決賽 10 組。", tag: "結果" },
      { start: "14:30", end: "15:00", title: "AI × Creative Technology", detail: "依特殊賽道獨立規則執行。", tag: "展示" },
      { start: "15:00", end: "15:50", title: "第二輪評選：總排名決賽 10 組", detail: "每隊 3 分鐘展示、1 分鐘提問、1 分鐘回答。", tag: "決賽" },
